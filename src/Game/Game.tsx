...
export interface IProps {
    columns: number;
    onScoreChange?: (previousScore: number, nextScore: number) => void;
    rows: number;
    running: boolean;
}
    ...
    public render() {
        ...
        return (
            <div>
                ...
                <div style={buttonStyle}><Button color="primary" disabled={!this.props.running} onClick={this.tryPosition}>Position</Button></div>
                <div style={buttonStyle}><Button color="primary" disabled={!this.props.running} onClick={this.tryPosition}>Sound</Button></div>
            </div>
        );
    }
